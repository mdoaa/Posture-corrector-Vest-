...
import 'package:sitguard/controllers/home/bluetooth_controller.dart';
...
class HomeScreenPage extends StatelessWidget {
  ...
  final BluetoothController btController = Get.find();
                      ...
                      child: Column(
                        children: [
                          ...
                          Obx(
                            () => ElevatedButton(
                              onPressed: () {
                                controller.toggleManualControl();
                              },
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    controller.manualControl.value
                                        ? Colors.green
                                        : Colors.grey[400],
                          ...
                          // Inflate and Deflate Buttons Row
                          Row(
                            children: [
                              // Inflate Button
                              Expanded(
                                child: Obx(
                                  () => GestureDetector(
                                    onTapDown: (_) {
                                      controller.inflatePressed();
                                    },
                                    onTapUp: (_) {
                                      controller.inflateReleased();
                                    },
                                    onTapCancel: () {
                                      controller.inflateReleased();
                                    },
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:
                                            controller.inflateActive.value
                                                ? Colors.blue[700]
                                                : Colors.blue[400],
                                        borderRadius: BorderRadius.circular(12),
                                        boxShadow:
                              ...
                              Expanded(
                                child: Obx(
                                  () => GestureDetector(
                                    onTapDown: (_) {
                                      controller.deflatePressed();
                                    },
                                    onTapUp: (_) {
                                      controller.deflateReleased();
                                    },
                                    onTapCancel: () {
                                      controller.deflateReleased();
                                    },
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:
                                            controller.deflateActive.value
                                                ? Colors.orange[700]
                                                : Colors.orange[400],
                                        borderRadius: BorderRadius.circular(12),
                                        boxShadow:
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          TextField(
                            controller: btController.ssidController,
                          ...
                          Obx(
                            () => TextField(
                              controller: btController.passwordController,
                              obscureText: !btController.passwordVisible.value,
                              decoration: InputDecoration(
                                labelText: "WiFi Password",
                                prefixIcon: const Icon(Icons.lock),
                                suffixIcon: IconButton(
                                  icon: Icon(
                                    btController.passwordVisible.value
                                        ? Icons.visibility_off
                                        : Icons.visibility,
                                  ),
                                  onPressed:
                                      btController.togglePasswordVisibility,
                                ),
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(12),
                                ),
                          ...
                          const SizedBox(height: 12),
                          Obx(
                            () => btController.statusMessage.value.isNotEmpty
                                ? Padding(
                                    padding: const EdgeInsets.only(bottom: 8),
                                    child: Text(
                                      btController.statusMessage.value,
                                      style: TextStyle(
                                        color: btController.statusMessage.value
                                                .contains("success")
                                            ? Colors.green
                                            : (btController
                                                        .statusMessage.value
                          ...
                          Obx(
                            () => ElevatedButton.icon(
                              onPressed: btController.isBusy.value
                                  ? null
                                  : btController.sendWifiCredentials,
                              icon: btController.isBusy.value
                                  ? const SizedBox(
                                      width: 18,
                                      height: 18,
